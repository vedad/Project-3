...
OBJECTS_PATH = '../data/conservations/angularmomentum/'
...
if __name__ == '__main__':
    ...
    fig = plt.figure()
    fig.suptitle("Earth's angular momentum")
    ax = fig.add_subplot(111)
    ax.set_title('$T = 100$, $dt=0.01$', fontsize='14')
    ax.set_xlabel('$t \\ \mathrm{[year]}$', fontsize='14')
    ax.set_ylabel('$\mathrm{Angular \\ momentum} \\ \mathrm{[GM_{sun} AU^2 year^{-1}]}$', fontsize='14')
    ax.grid('on')
